...
git config --global user.name "Jan Kowalski" git config --global
...
$ git status On branch main No commits yet Untracked files: (use "git
add ..." to include in what will be committed) plik.txt
