...
*Podpis: Uproszczony przepływ pracy w systemie Git.*

(Uwaga: Pamiętaj, aby podmienić sciezka/do/twojego/obrazka.png na
faktyczną ścieżkę do pliku graficznego w Twoim projekcie).
